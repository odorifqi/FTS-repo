    ...
    private JPanel createButton(){
        ...
        input.addActionListener((ActionEvent e) -> {
            if (fileChooser.showOpenDialog(Home.this) == JFileChooser.APPROVE_OPTION) {
                try {    
                    controller.inputFile(fileChooser.getSelectedFile()); //work
                    tablePanel.refresh();
        ...
        predict.addActionListener((ActionEvent e) -> {
            ...
            if(interval != 0){
                ...
                detailPanel.setText("Max Value: " + Double.toString(controller.getMaxValue()) + "\n" + "\n" +
                                     "Min Value: " + Double.toString(controller.getMinValue()) + "\n" + "\n" +
                                     "Interval Range: " + Double.toString(controller.getLompatan()) + "\n" + "\n" +
